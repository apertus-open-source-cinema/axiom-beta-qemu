...
files=('dev/testimage.tar.gz')

links=('https://github.com/MedicineYeh/microzed-image/archive/v1.0.tar.gz')

sha256sums=('80596dfca85173b0e1bf3355f8c861d030c1c6529ebb4417f27935fc30767c20')
